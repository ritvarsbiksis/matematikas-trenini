 ...
 *
 * Inlined as SVG rather than fetched: the app must not depend on a third-party
 * CDN to render its own login screen. Each mark is decorative — the button's
 * visible text carries the accessible name — so they are `aria-hidden`.
 */
...
/** Uses `currentColor` so the mark inverts with the button text in dark mode. */
...
export function FacebookIcon({ className }: Readonly<IconProps>) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      ...
      <path
        fill="#ffffff"
        d="m16.67 15.47.53-3.47h-3.32V9.75c0-.95.46-1.87 1.95-1.87h1.51V4.93s-1.37-.24-2.68-.24c-2.74 0-4.53 1.67-4.53 4.67V12H7.08v3.47h3.04v8.38a12.1 12.1 0 0 0 3.76 0v-8.38h2.79Z"
      />
    </svg>
  )
}
